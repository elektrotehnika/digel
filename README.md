...
Прелиминарни резултати друге и треће лаб вежбе налазе се [овде](https://docs.google.com/spreadsheets/d/1rXWBFgnk-9rhvAgkDkMtKDZDPot1asxDPgyBQ71rqTM/edit?gid=0#gid=0). Парцијално додељене поене студенти могу наћи и у својим гит репозиторијумима лаб вежби (комитови са таговима `lab2-res` и `lab3-res`).
